...
esp_lcd_panel_io_handle_t BrigPanelHandle;
...
static const sh8601_lcd_init_cmd_t lcd_init_cmds[] = {
    ...
    {0x2A, (uint8_t []){0x00,0x10,0x00,0xD1}, 4, 0}, //D1 0x01,0xD1
    {0x2B, (uint8_t []){0x00,0x00,0x00,0x57}, 4, 0}, //0x02,0x57
...
void app_main(void)
{
    ...
    robot_face_start_network();
}


bool robot_face_lvgl_lock(int timeout_ms){ return example_lvgl_lock(timeout_ms); }
void robot_face_lvgl_unlock(void){ example_lvgl_unlock(); }
